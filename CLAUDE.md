...
- **Privacy at the parser boundary.** `internal/telemetry` extracts metadata and drops bodies before anything is published. Recipient addresses are hashed. Never store or log message bodies.
